 ...
 */
fun findImplementations(root: File, type: String, maxMatches: Int, astCache: AstCache = AstCache()): List<ImplementationMatch> {
...
fun runFindImplementations(root: File, type: String, maxMatches: Int, astCache: AstCache = AstCache()): String {
    ...
    val matches = findImplementations(root, trimmed, maxMatches, astCache)
    if (matches.isEmpty()) {
